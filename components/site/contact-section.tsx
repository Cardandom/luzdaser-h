    ...
    <section id="contacts" className="luxury-shell mt-6 sm:mt-8">
      <div className="luxury-panel rounded-[32px] px-5 py-8 sm:px-8 lg:px-10">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <form className="luxury-card rounded-[28px] p-5 sm:p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="grid gap-2 text-sm text-[#2B2B2B]/75">
                Name
              ...
              <label className="grid gap-2 text-sm text-[#2B2B2B]/75 sm:col-span-2">
                Comments
                <textarea
            ...
            <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                type="button"
                className="inline-flex h-12 items-center justify-center rounded-full bg-[linear-gradient(180deg,#f2dcaf,#c58f3c)] px-6 font-semibold text-[#140e05] shadow-[0_18px_35px_rgba(220,181,109,0.28)] transition-transform hover:-translate-y-0.5"
              >
                Send request
              </button>
            </div>
          ...
          <aside className="luxury-card relative overflow-hidden rounded-[28px] p-5 sm:p-6">
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(247,247,243,0.98)),radial-gradient(circle_at_30%_20%,rgba(220,181,109,0.18),transparent_28%),radial-gradient(circle_at_75%_30%,rgba(43,43,43,0.06),transparent_18%),linear-gradient(135deg,#ffffff_0%,#f8f7f3_45%,#ffffff_100%)]" />
            <div className="relative flex h-full min-h-[320px] flex-col justify-between gap-6">
              <div className="self-start rounded-full border border-black/10 bg-white px-4 py-2 text-sm text-[#2B2B2B]/70">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-[24px] border border-black/10 bg-white p-4">
                  ...
                  <p className="text-sm text-[#2B2B2B]/70">Of the initial deposit.</p>
                </div>
                <div className="rounded-[24px] border border-black/10 bg-white p-4">
                  <p className="text-xs uppercase tracking-[0.28em] text-[#2B2B2B]/50">
                    Benefit
                  ...
                  <p className="text-sm text-[#2B2B2B]/70">Tax exemption.</p>
                </div>
              </div>

              <div className="space-y-3 rounded-[24px] border border-black/10 bg-white p-4 text-sm text-[#2B2B2B]/75">
                <div className="flex items-center gap-3">
                  <Phone className="size-4 text-luxury-gold" aria-hidden="true" />
                  <span>+297 123 4567</span>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="size-4 text-luxury-gold" aria-hidden="true" />
                  <span>info@luxuryvillasaruba.com</span>
                </div>
                <div className="flex items-center gap-3">
